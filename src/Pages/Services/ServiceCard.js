...
const ServiceCard = ({ service }) => {
    ...
    return (
        <div className='bg-hov2 '>
            <div className=" bg-gradient-to-r from-orange-400 to-red-400 w-[95%] card-shadow lg:h-[32rem] h-[29rem] md:h-[31rem] mx-auto rounded-md  my-3 relative text-white" data-aos="zoom-in-up" data-aos-duration='1000' >
